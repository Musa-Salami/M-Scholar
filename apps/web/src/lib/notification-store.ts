...
const SEED_NOTIFICATIONS: AppNotification[] = [
  {
    ...
    body: "New term results are available for Amina Bello (JSS 2A).",
    href: "/portal/results",
    read: false,
  ...
  },
  {
    ...
    body: "Amina has shown great improvement in Mathematics this week.",
    href: "/portal/notes",
    read: false,
  ...
  },
  {
    ...
    body: "Blessing Eze (J1BE26) paid ₦40,000 toward First Term fees.",
