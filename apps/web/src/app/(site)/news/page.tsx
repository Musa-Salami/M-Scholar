const NEWS = [
  ...
  { date: "2026-02-01", title: "Term 2 Results Published", excerpt: "First term report cards are now available on the parent and student portal. Log in to view and download." },
